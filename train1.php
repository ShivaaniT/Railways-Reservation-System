...
$q="select * from train2 where source='$source' and destination='$destination' ";
$result=mysqli_query($con,$q);
$row_count=mysqli_num_rows($result);
?>

<table class="flat-table flat-table-1" style="position: relative;left: 28%;">
...
<footer style=" position:relative; top:320px;">
